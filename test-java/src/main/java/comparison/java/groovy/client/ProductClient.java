...
/**
 ...
 Attempting to add a product client fall back identical to java example in the groovy project causes this issue
 ...
 https://www.google.co.uk/search?q=BUG!+exception+in+phase+%27canonicalization%27+in+source+unit&oq=BUG!+exception+in+phase+%27canonicalization%27+in+source+unit
